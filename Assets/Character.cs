...
public class Character
{
   ...
   // public bool isInParty;
    ...
    public void CharacterData(int _iconID, string _playerName, string _characterName,int _characterHP, int _characterInitiative, string _characterRace, string _characterClass)
    {
        iconID = _iconID;
        playerName = _playerName;
        characterName = _characterName;
